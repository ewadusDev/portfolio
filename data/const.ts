...
export const skills = [
  ...
  {
    icons: [
      "/skills/node-icon.svg",
      "/skills/express-icon.svg",
      "/skills/redis-icon.svg",
      "/skills/nginx-icon.svg",
    ],
    name: "Backend",
    description: "NodeJS, Express, Redis, nginx",
  },
  {
    icons: [
